		...
		<div class="bg-stone-200">
			<div class="py-20">
				...
				<div class="px-10 pb-10 text-xl text-center text-black">
					...
					Standar
					<a class="font-bold underline underline-offset-2 decoration-2 decoration-orange-500">SNI</a>,
					Menyediakan
					<a class="font-bold underline underline-offset-2 decoration-2 decoration-orange-500"
						>Berbagai Macam</a
					>
					Mutu Beton
				</div>
