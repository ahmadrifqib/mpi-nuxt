<template>
	...
	<div class="bg-stone-200">
		<div class="py-20">
			<div class="pt-10 text-5xl font-bold text-center text-orange-500">Mixa Beton</div>
			<div class="px-10 pb-10 text-xl text-center text-black">
				<a class="font-bold underline underline-offset-2 decoration-2 decoration-orange-500">Hemat</a>, Mutu
				Standar <a class="font-bold underline underline-offset-2 decoration-2 decoration-orange-500">SNI</a>,
				Menyediakan
				<a class="font-bold underline underline-offset-2 decoration-2 decoration-orange-500">Berbagai Macam</a>
				Mutu Beton
			</div>
